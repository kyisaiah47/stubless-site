...
export const metadata: Metadata = { title: 'stubless, the RuleStack score gate', description: "Score a repository's agent instructions, then fail the job below its threshold.", metadataBase: new URL(PRODUCT.host) };
